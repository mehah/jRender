...
public final class $Container {
	...
	public static Field[] getElementFields(ContainerElementImplementation e) {
		if(e instanceof Form)
			...
			return com.jrender.jscript.dom.elements.custom.$Container.getElementFields((ContainerElement<?>) e);
		...
		if(fields == null) {
			...
			do {
				for(Field field: GenericReflection.getDeclaredFields(currentClass)) {
					if(field.isAnnotationPresent(com.jrender.jscript.dom.form.annotation.ElementValue.class)) {
						...
						/*if(!(
							...
							com.jrender.jscript.dom.elements.$Element.isElementWithValue(type) ||
							ClassUtils.isPrimitiveOrWrapper(type) ||
							ClassUtils.isParent(type, ContainerElement.class))) {
								throw new OperationNotAllowedException(LogMessage.getMessage("0028", field.getName(), currentClass.getSimpleName()));
						}*/
