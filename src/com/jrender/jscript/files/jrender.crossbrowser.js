if (!JSON || !JSON.stringify) {
	JRender.util.loadScript(JRender.CONTEXT_PATH + "/jscript/jrender/json3.js", false);
}
...
if (!('querySelectorAll' in Element.prototype)) {
	JRender.util.loadScript(JRender.CONTEXT_PATH + "/jscript/jrender/sizzle.js", false);
