...
public final class DatabaseConnection implements Connection {
	...
	private DatabaseConfig config = JRenderConfig.Server.DataBase.getConfig(JRenderConfig.Server.DataBase.defaultConfigFile);
	...
	public void start() throws SQLException {
		close();
		if(config == null) {
			throw new JRenderError(LogMessage.getMessage("db-0008"));
		}
		...
		try {
			...
			Console.warning(url + "\n" + LogMessage.getMessage("db-0001", config.getDatabase()));

			if (config.getChanceReconnect() > 0 && chanceConnected < config.getChanceReconnect()) {
				Console.log(LogMessage.getMessage("db-0002"));
				try {
					Thread.sleep(250);
				...
				System.out.println(LogMessage.getMessage("db-0003", config.getConnectionFileName()));
				config = JRenderConfig.Server.DataBase.getConfig(config.getConnectionFileName());
				start();
			} else
				throw e;
		}
	...
	Connection getConnection() throws SQLException {
		if (connection == null)
			throw new SQLException(LogMessage.getMessage("db-0004"));

		if (connection.isClosed())
			throw new SQLException(LogMessage.getMessage("db-0005"));
	...
	public CallableStatement prepareCall(String sql) throws SQLException {
		return (CallableStatement) addStatements(new DatabaseCallableStatement(this, sql));
	}

	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
		return (CallableStatement) addStatements(new DatabaseCallableStatement(this, sql, resultSetType, resultSetConcurrency));
	}

	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		return (CallableStatement) addStatements(new DatabaseCallableStatement(this, sql, resultSetType, resultSetConcurrency, resultSetHoldability));
	}
