...
public final class ViewSession implements Serializable {
	...
	private final Runnable task = new Runnable() {
		public void run() {
			if(!This.session.isValid() || This.thisAccessedTime+(maxInactiveInterval*1000) < System.currentTimeMillis()) {
				//Console.log(LogMessage.getMessage("green-0026", This.getId()));
				This.invalidate();
			}
		}
	};
	...
	public Enumeration<String> getAttributeNames() { return attributes.keys(); }
	...
	public ViewSessionContext getViewSessionContext() { return context; }

	public Object getValue(String arg0) { return attributes.values(); }
	...
	public void putValue(String arg0, Object arg1) { attributes.put(arg0, arg1); }

	public void removeAttribute(String arg0) { attributes.remove(arg0); }

	public void removeValue(String arg0) { attributes.values().remove(arg0); }
