Greencode.tags = {
	...
	buttons: function(mainElement) {
		...
		for(var i = -1; ++i < elements.length;) {
			...
			element.registerEvent('click', function() {
				var data = {}, form = this.form, _es = form.querySelectorAll('input, textarea, select'), request = new Request(this.getAttribute('action'), Greencode.EVENT_REQUEST_TYPE, Greencode
						.isRequestSingleton());
