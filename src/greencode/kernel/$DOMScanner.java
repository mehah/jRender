...
public final class $DOMScanner {
	...
	public static boolean hasRegisteredCommand(ViewSession viewSession) { return !DOMScanner.getElements(viewSession).comm.isEmpty(); }
	public static void setSync(GreenContext context, int uid, String varName, JSExecutor jsCommand) throws IOException { DOMScanner.setSync(context, uid, varName, jsCommand); }
}
