...
public class WebSocketConfigurator extends ServerEndpointConfig.Configurator {
	...
	private final static Field
		...
		requestContextField = GenericReflection.NoThrow.getDeclaredField(Request.class, "context");
	...
	public void modifyHandshake(ServerEndpointConfig config, HandshakeRequest request, HandshakeResponse response) {
		...
		config.getUserProperties().put("context", GenericReflection.NoThrow.getValue(requestContextField, _requestFaced));
